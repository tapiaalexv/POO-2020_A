...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        Rectangulo tercerRectangulo = new Rectangulo(70,6);
        
        Rectangulo cuartoRectangulo = new Rectangulo(75,1);
        
        tercerRectangulo.calcularArea();
        cuartoRectangulo.calcularArea();
        
        System.out.println("los rectangulos son iguales -> "+tercerRectangulo.equals(cuartoRectangulo)+" "+tercerRectangulo.getArea()+" "+cuartoRectangulo.getArea());
